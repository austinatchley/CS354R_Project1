...
ACLOCAL = ${SHELL} /u/austina/GameTech/Project1/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /u/austina/GameTech/Project1/missing autoconf
AUTOHEADER = ${SHELL} /u/austina/GameTech/Project1/missing autoheader
AUTOMAKE = ${SHELL} /u/austina/GameTech/Project1/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /u/austina/GameTech/Project1/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.1
abs_builddir = /u/austina/GameTech/Project1
abs_srcdir = /u/austina/GameTech/Project1
abs_top_builddir = /u/austina/GameTech/Project1
abs_top_srcdir = /u/austina/GameTech/Project1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /u/austina/GameTech/Project1/install-sh
